...
export default function privacy() {
  return (
    <div className={styles.containerPrivacy}>
      ...
      <p>
        Damien built the OneDayOneWorkout app as a Freemium app. This SERVICE is
        provided by Damien at no cost and is intended for use as is.
      </p>{" "}
      <p>
      ...
      <p>
        ...
        Terms and Conditions, which are accessible at OneDayOneWorkout unless
